...
public class Constants {
    ...
    public static final String EXTRA_IS_INITIATOR = "EXTRA_IS_INITIATOR";

    // ############  PreferenceManager entry name

    public static final String PF_UID = "pf_uid";

    //    ############### App data
    public static final String APP_DATA_USER = "APP_DATA_USER";
    public static final String APP_DATA_UID = "APP_DATA_UID";

    //    ############### result request code
    public static final int RESULT_REQ_CODE_CAMERA = 2;

    // ############# permission request  code

    public static final int PERM_REQ_CODE_CAMERA_AUDIO = 1;
